...
class JayDLLauncher:
    ...
    def check_dependencies(self):
        ...
        if not env_file.exists():
            ...
            if env_example.exists():
                ...
                print("📝 IMPORTANT: An environment file has been created at 'backend/.env'.")
                print("   You MUST edit this file and add your secrets before running again.")
                print("   - Add your 'RAPIDAPI_SPOTIFY_KEY'.")
                print("   - Add a 'FLASK_SECRET_KEY' (can be any random string).")
                return False
            else:
    ...
    def print_status(self):
        ...
        print("-" * 50)
        print("⚠️  TROUBLESHOOTING TIP".center(50))
        print("If the app isn't working locally, ensure your frontend code")
        print("(in the 'frontend' folder) is pointing to the LOCAL backend:")
        print("   const backendUrl = 'http://localhost:5000';")
        print("Do NOT use the production URL ('...onrender.com') for local testing.")
        print("="*50)
